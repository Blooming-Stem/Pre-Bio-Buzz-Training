...
public class DriveIMUSetup {

    private DcMotor front_leftMotor, back_leftMotor, front_rightMotor, back_rightMotor,enc_right,enc_left,enc_x;
    ...
    public void drive(double forward, double strafe, double rotate){
        ...
        front_leftMotor.setPower(maxSpeed * (frontLeftPower / maxPower));

        maxPower = Math.max(maxPower, Math.abs(backLeftPower));
        back_leftMotor.setPower(maxSpeed * (backLeftPower / maxPower));

        maxPower = Math.max(maxPower, Math.abs(frontRightPower));
        front_rightMotor.setPower(maxSpeed * (frontRightPower / maxPower));

        maxPower = Math.max(maxPower, Math.abs(backRightPower));
        back_rightMotor.setPower(maxSpeed * (backRightPower / maxPower));
